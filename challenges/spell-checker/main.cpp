...
//     cout << "The edit distance between 'spelling' and 'spelling' is "
//          << edit_distance("spelling", "spelling") << endl;

//     cout << "The edit distance between 'speling' and 'spelling' is "
//          << edit_distance("speling", "spelling") << endl;

//     cout << "The edit distance between 'speling' and 'a' is "
//          << edit_distance("speling", "a") << endl;

//     cout << "The edit distance between 'peotryy' and 'poetry' is "
//          << edit_distance("peotryy", "poetry") << endl;
...
//          << endl;
    ...
    edit_distance_bonus("an","na") << endl;

    cout << "The edit distance between 'spelling' and 'spelling' is " <<
    edit_distance_bonus("spelling","spelling") << endl;

    cout << "The edit distance between 'speling' and 'spelling' is " <<
    edit_distance_bonus("speling","spelling") << endl;

      cout << "The edit distance between 'speling' and 'a' is " <<
    edit_distance_bonus("speling","a") << endl;

    cout << "The edit distance between 'peotryy' and 'poetry' is " <<
    edit_distance_bonus("peotryy","poetry") << endl;

    cout << "The edit distance between 'korrectud' and 'corrected' is " <<
    edit_distance_bonus("korrectud","corrected") << endl;

    cout << "The edit distance between 'nonexistential' and 'nonexistent' is "
    << edit_distance_bonus("nonexistential","nonexistent") << endl;
