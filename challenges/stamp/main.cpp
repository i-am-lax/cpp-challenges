...
// Input 'status' to human readable output
...
int main() {
    ...
    char digest[41];
    text_to_SHA1_digest("The bitcoin is under the carpet in the living room.",
                        digest);
    cout << "SHA1 digest of message 'The bitcoin is under the carpet in the "
            "living room' is:"
         << endl
         << digest << endl
         << endl;

    text_to_SHA1_digest("The bitcoin is under the carpet in the dining room.",
                        digest);
    cout << "SHA1 digest of message 'The bitcoin is under the carpet in the "
            "dining room' is:"
         << endl
    ...
    cout << "Checking email with header " << endl
         << "'wjk@imperial.ac.uk:60eb8db1a3c0ea1ad3d5548f248b4a3e73711ee5:"
            "313889'"
         << endl
         << "sent to 'wjk@imperial.ac.uk' with body 'message1.txt':" << endl;
    MessageStatus result = check_header(
        "wjk@imperial.ac.uk",
    ...
    cout << "Checking email with header " << endl
         << "'wjk@imperial.ac.uk:60eb8db1a3c0ea1ad3d5548f248b4a3e73711ee5:"
            "313889'"
         << endl
         << "sent to 'fs@imperial.ac.uk' with body 'message1.txt':" << endl;
    result = check_header(
        "fs@imperial.ac.uk",
        "wjk@imperial.ac.uk:60eb8db1a3c0ea1ad3d5548f248b4a3e73711ee5:313889",
        "message1.txt");
    ...
    cout << "Checking email with header " << endl
         << "'wjk@imperial.ac.uk:60eb8db1a3c0ea1ad3d5548f248b4a3e73711ee5:"
            "313889'"
         << endl
         << "sent to 'wjk@imperial.ac.uk' with body 'message2.txt':" << endl;
    result = check_header(
        "wjk@imperial.ac.uk",
        "wjk@imperial.ac.uk:60eb8db1a3c0ea1ad3d5548f248b4a3e73711ee5:313889",
        "message2.txt");
    ...
    cout << "Checking email with header " << endl
         << "'wjk@imperial.ac.uk:60eb8db1a3c0ea1ad3d5548f248b4a3e73711ee5:"
            "875231'"
         << endl
         << "sent to 'wjk@imperial.ac.uk' with body 'doesnotexist.txt':"
         << endl;
    result = check_header(
        "wjk@imperial.ac.uk",
        "wjk@imperial.ac.uk:60eb8db1a3c0ea1ad3d5548f248b4a3e73711ee5:875231",
