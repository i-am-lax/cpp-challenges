...
int main() {
    ...
    cout << "The character 't' encoded in braille is '" << braille << "' ("
         << size << " characters)" << endl;

    size = encode_character('Z', braille);
    cout << "The character 'Z' encoded in braille is '" << braille << "' ("
         << size << " characters)" << endl;

    size = encode_character('5', braille);
    cout << "The character '5' encoded in braille is '" << braille << "' ("
         << size << " characters)" << endl;

    size = encode_character('.', braille);
    cout << "The character '.' encoded in braille is '" << braille << "' ("
         << size << " characters)" << endl;
