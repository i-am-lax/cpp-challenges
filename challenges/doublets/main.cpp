...
int main() {
    ...
    cout << "The word 'WHEAT' is " << (found ? "" : "NOT ")
         << "found in the dictionary." << endl
         << endl;
    ...
    cout << "From 'WHEAT' to 'TEA' is " << (valid ? "" : "NOT ")
         << "a valid step." << endl
         << endl;

    valid = valid_step("WHEAT", "CHEAP");
    cout << "From 'WHEAT' to 'CHEAP' is " << (valid ? "" : "NOT ")
         << "a valid step." << endl
         << endl;

    valid = valid_step("TEA", "SEA");
    cout << "From 'TEA' to 'SEA' is " << (valid ? "" : "NOT ")
         << "a valid step." << endl
         << endl;
...
//     cout << (success ? "Found" : "Could not find")
//          << " a chain from 'WET' to 'DRY' with up to 4 steps" << endl;
...
//     cout << (success ? "Found" : "Could not find")
//          << " a chain from 'APE' to 'MAN' with up to 6 steps" << endl;
...
//     cout << (success ? "Found" : "Could not find")
//          << " a chain from 'BLACK' to 'WHITE' with up to 8 steps" << endl;
//     if (success)
//         display_chain(answer, cout);
//     cout << endl;
...
//     cout << (success ? "Found" : "Could not find")
//          << " a chain from 'KETTLE' to 'HOLDER' with up to 10 steps" << endl;
//     if (success)
//         display_chain(answer, cout);
//     cout << endl;
...
//     cout << (success ? "Found" : "Could not find")
//          << " a chain from 'WITCH' to 'FAIRY' with up to 12 steps" << endl;
//     if (success)
//         display_chain(answer, cout);
//     cout << endl;
    ...
    success = find_chain("*YOUR START WORD HERE*", "*YOUR TARGET WORD HERE*",
    answer, YOUR_STEPS);
